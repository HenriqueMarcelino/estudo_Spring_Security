...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	/*Configuração para trabalhar com security, aqui o proprio security
	 * está bloqueando o css da pagina e outros para que não seja acessado 
	 * sem estarmos na url correta que seria a inicial "home".
	 * 
	 * Estamos liberando os webjars/ o "**" é para liberar tudo que vem depois 
	 * daquela barra.
	 * 
	 * Aqui também estamos fazendo a validação de senhas, e fazendo a criptografia delas.
	 * 
	 */
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		//Acessos Publicos liberados.
			...
			// Estamos definido as permiçoes, cada usuario que conter, exemplo /u/alguma coisa 
