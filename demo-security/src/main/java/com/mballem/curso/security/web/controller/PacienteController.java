...
public class PacienteController {
	...
	// Metodo para abrir a pagina de dados pessoais do paciente e mostrar as
	// informações, com o email com a opção de não editavel.
	...
	// Metodo para salvar o formulario de dados pessoais do paciente com verificação
	// de senha, digitada e senha armazenada no banco
	...
	// Metodo para editar o formulario de dados pessoais do paciente com verificação
		// de senha, digitada e senha armazenada no banco
